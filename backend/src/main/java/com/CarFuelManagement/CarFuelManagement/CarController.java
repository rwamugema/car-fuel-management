...
public class CarController {
    ...
    public ResponseEntity<Fuel> addFuelToCar(
        ...
        Integer liters = ((Number) body.get("liters")).intValue();
        Integer price = ((Number) body.get("price")).intValue();
        Integer odometers = ((Number) body.get("odometers")).intValue();
    ...
    public ResponseEntity<Map<String, Object>> getFuelStats(@PathVariable("id") Long id) {
